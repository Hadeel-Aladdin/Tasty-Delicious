...
function Footer() {
    return (
        <footer className="bg-cream text-espresso dark:bg-zinc-950 dark:text-zinc-300 pt-12 pb-8 border-t border-mustard/20">
            <div className={`${zain.className} max-w-6xl mx-auto px-6 grid grid-cols-1 md:grid-cols-3 gap-8 text-center md:text-right items-start`}>

                {/* Section 1: Brand Logo & Links */}
                <div className="flex flex-col items-center md:items-start gap-4">
                    ...
                    <nav className="flex flex-wrap items-center justify-center md:justify-start gap-4 text-xl font-semibold text-espresso/80 dark:text-cream/80 pt-2">
                ...
                <div className="flex flex-col items-center gap-4 w-full text-center">
                    <h3 className="text-2xl font-bold text-mustard w-full text-center">
                        تابعنا على
                    </h3>
                ...
                {/* Section 2: Contact Us & Info */}
                <div dir="rtl" className="flex flex-col items-start gap-3 text-right">
                    <h3 className="text-2xl font-bold text-mustard flex items-center gap-2">
                        <span>تواصل معانا</span>
                    </h3>

                    <div className="flex items-center gap-2 text-lg text-espresso/80 dark:text-cream/80">
            ...
            {/* Bottom Bar */}
            <div className={`max-w-6xl mx-auto px-6 mt-8 pt-6 border-t border-black/10 dark:border-cream/10 text-center ${zain.className} text-base font-semibold text-espresso/70 dark:text-cream/70`}>
